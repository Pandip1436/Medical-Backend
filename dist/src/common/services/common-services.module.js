...
const document_numbering_service_1 = require("./document-numbering.service");
...
exports.CommonServicesModule = CommonServicesModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        providers: [document_numbering_service_1.DocumentNumberingService],
        exports: [document_numbering_service_1.DocumentNumberingService],
    })
